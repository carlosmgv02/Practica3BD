...
insert into paisos(nom, pot_desenc, tractat_signat) VALUES ('Spain',true,false);
insert into paisos(nom, pot_desenc, tractat_signat) VALUES ('Germany',true,false);
insert into paisos(nom, pot_desenc, tractat_signat) VALUES ('France',false,true);
...
insert into zona_biocon(codi,codiLab,nivell,responsable) values('32145',123,3,'49424598J');
insert into zona_biocon(codi,codiLab,nivell,responsable) values('12345',12,3,'12345678P');
insert into zona_biocon(codi,codiLab,nivell,responsable) values('54321',7,5,'83128731T');
